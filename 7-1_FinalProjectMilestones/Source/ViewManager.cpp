...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to recieve mouse wheel scrolling events
...
void ViewManager::Mouse_Wheel_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	// call the camera class to process the mouse wheel scrolling
	// set to negative so that up = faster, down = slower
